...
Scanner sc = new Scanner(System.in);
	...
	private static ArrayList<Categoria> cargarCategorias() {
        ...
        categorias.add(new Categoria(1, "Videojuegos"));
        categorias.add(new Categoria(2, "Consolas"));
        categorias.add(new Categoria(3, "Juguetes"));
        categorias.add(new Categoria(4, "Remeras"));
	...
	private static ArrayList<Articulo> cargarArticulos(ArrayList<Categoria> categorias) {
        ...
        articulos.add(new Articulo(1, "Super Mario", 100000.00, 20, categorias.get(0))); // Electrónica
        articulos.add(new Articulo(2, "Tetris", 100000.00, 10, categorias.get(0)));
        articulos.add(new Articulo(3, "Pacman", 75000.00, 30, categorias.get(0)));

        articulos.add(new Articulo(4, "NES", 250000.00, 15, categorias.get(1))); // Hogar
        articulos.add(new Articulo(5, "Sega", 175000.00, 40, categorias.get(1)));
        articulos.add(new Articulo(6, "Gameboy", 220000.00, 20, categorias.get(1)));

        articulos.add(new Articulo(7, "Super Mario Muneco 20 cm", 35000.00, 50, categorias.get(2))); // Juguetes
        articulos.add(new Articulo(8, "Auto a control remoto estilo PACMAN", 85000.00, 30, categorias.get(2)));
        articulos.add(new Articulo(9, "Bloques de construcción tipo TETRIS", 55000.00, 40, categorias.get(2)));

        articulos.add(new Articulo(10, "Remera Super Mario Bros", 25000.00, 40, categorias.get(3))); // Ropa
        articulos.add(new Articulo(11, "Remera Super Nintendo", 25000.00, 30, categorias.get(3)));
        articulos.add(new Articulo(12, "Remera Tetris Retro 25 anos", 35000.00, 20, categorias.get(3)));
